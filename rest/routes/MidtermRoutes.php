...
Flight::route('POST /midterm/investor', function(){
    ...
    */
    ...
    $result = Flight::midtermService()->investor($data['first_name'], $data['last_name'], $data['email'], $data['company']);
    Flight::json($result);
...
Flight::route('GET /midterm/investor_email/@email', function($email){
    ...
    */
    ...
    $result = Flight::midtermService()->investor_email($email);
    Flight::json($result);
...
Flight::route("GET /midterm/investor/@share_class_id", function($share_class_id){
    ...
    */
    ...
    $result = Flight::midtermService()->investors($share_class_id);
    Flight::json($result);
